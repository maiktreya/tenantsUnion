...
INSERT INTO sindicato_inq.usuario_credenciales (usuario_id)
SELECT id FROM sindicato_inq.usuarios
WHERE id NOT IN (SELECT usuario_id FROM sindicato_inq.usuario_credenciales);

-- Ejemplo de inserción de datos (a modo de demostración)
INSERT INTO sindicato_inq.roles (nombre, descripcion) VALUES ('admin', 'Administrador con todos los permisos');
INSERT INTO sindicato_inq.roles (nombre, descripcion) VALUES ('gestor', 'Gestor de conflictos y afiliadas');
