...
Puedes consultar un diagrama ERD completo de la base de datos [en el siguiente enlace](https://github.com/maiktreya/tenantsUnion/blob/main/doc/ERD_database.png). ¡Son solo 17 tablas base!
